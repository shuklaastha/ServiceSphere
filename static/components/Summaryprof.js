export default {
    template: `
      <div 
        ...
        <div class="container d-flex flex-wrap justify-content-center">
          ...
          <div 
            ...
            <div class="card-body">
              ...
              <p class="small text-muted" style="font-style: oblique;">Services rejected.</p>
            </div>
          </div>
        ...
        <div 
            ...
            style="width: 18rem; background: rgba(255, 255, 255, 0.9); border-radius: 10px;">
            <div class="card-body">
              <h3 class="card-title" style="font-style: oblique;">Rating</h3>
              <h2 style="font-style: oblique;">{{ average_rating }}</h2>
              <p class="small text-muted" style="font-style: oblique;">Your average rating</p>
            </div>
          </div>
        </div>
      </div>
    ...
    async mounted() {
      try {
        const res = await fetch(`/api/summary-prof?prof_id=${this.prof_id}`, {
          headers: {
